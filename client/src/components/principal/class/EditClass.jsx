    ...
    <>
      <div className="md:ml-64 p-4">
        <section className="bg-fuchsia-100 rounded-3xl bottom-10">
          ...
          {removeOn && (
            <div className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
              <RemoveTeacher setRemoveOn={setRemoveOn}/>
            </div>
          )}
          <div class="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
            <div class="col-span-2 mb-5 ">
              <div class="p-4  rounded-xl text-gray-800">
                <div class="font-bold text-xl leading-none underline underline-offset-4 flex">
                  Class Name : {currentClass.className} {currentClass.division}{" "}
                  <FiEdit
                    className="cursor-pointer ml-3"
                    onClick={() => setUpdate((state) => (state = !state))}
                  />
                </div>
              </div>
            </div>
            ...
            <div class="flex">
             ...
             {  currentClass?.classTeacher &&    <AiFillDelete
                    onClick={() => setRemoveOn(true)}
                    className="cursor-pointer ml-3"
                  />}
                </div>
                ...
                <h2 class="mt-2 font-bold flex justify-center">
                ...
                <div className="m-4 flex flex-col h-fit gap-6 justify-between">
                  <p class="hidden mt-2 sm:block sm:text-sm sm:text-gray-600 ">
                    Subject :{" "}
                    {currentClass?.classTeacher
                      ? currentClass?.classTeacher?.class
                      : "Not Assigned"}
                  </p>
                  <p class="hidden mt-2 sm:block sm:text-sm sm:text-gray-600">
                    Email :{" "}
                    {currentClass?.classTeacher
                      ? currentClass?.classTeacher?.division
                      : "Not Assigned"}
                  </p>
                  <p class="hidden mt-2 sm:block sm:text-sm sm:text-gray-600 ">
                    Phone :{" "}
                    {currentClass?.classTeacher
                      ? currentClass?.classTeacher?.phone
                      : "Not Assigned"}
                  </p>
                </div>
              </div>
              ...
              <div className="w-2/3">
                <div className=" border border-gray-500 p-4 shadow-sm rounded-xl mx-5 h-fit">
                  ...
                  <div className="h-[25rem] overflow-y-scroll ">
                    <div className="grid grid-cols-1  sm:h-fit  ">
                      {students.length > 0 ? (
                        ...
                        <>
                          <div className="text-md text-red-500 text-center  items-center">
                            Students Not Found !{" "}
                          </div>
                        </>
                      )}
